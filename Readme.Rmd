...
plot_model(fit15, type = "pred", terms = c("participant_vocabulary_size","word_familiarity [20,30,40]","participant_age [14, 25, 70]")) +
  theme_bw() +
...
plot_model(fit15, type = "pred", terms = c("participant_age","word_familiarity [20,30,40]","participant_vocabulary_size [15, 35, 47]")) +
  theme_bw() +
...
plot_model(fit15, type = "pred", terms = c("participant_vocabulary_size","participant_age [14, 25, 70]","word_familiarity [20,30,40]")) +
  theme_bw() +
